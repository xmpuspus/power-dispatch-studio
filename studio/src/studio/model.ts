...
export const CLASSES: SystemClass[] = [
  {
    ...
    props: [
      ...
      {
        key: 'marginal_cost',
        label: 'Assigned fuel-block cost',
        unit: '₱/kWh',
        editable: true,
        dp: 2,
      },
      {
        key: 'for_pct',
        label: 'Assumed outage rate by fuel',
        unit: '%',
        editable: true,
        dp: 0,
      },
  ...
  },
  {
    ...
    props: [
      {
        key: 'cost',
        label: 'Marginal cost assumption',
        unit: '₱/kWh',
        editable: true,
        dp: 2,
      },
      {
        key: 'luzon_mw',
        label: 'Modeled Luzon availability',
        unit: 'MW',
        editable: true,
        dp: 0,
      },
      {
        key: 'visayas_mw',
        label: 'Modeled Visayas availability',
        unit: 'MW',
        editable: true,
        dp: 0,
      },
      {
        key: 'mindanao_mw',
        label: 'Modeled Mindanao availability',
        unit: 'MW',
        editable: true,
        dp: 0,
      },
  ...
  },
  {
    ...
    props: [
      {
        key: 'demand_mw',
        label: 'Modeled load at reference hour',
        unit: 'MW',
        editable: true,
        dp: 0,
      },
      {
        key: 'peak_mw',
        label: 'Recorded-window evening peak',
        unit: 'MW',
        editable: false,
        dp: 0,
      },

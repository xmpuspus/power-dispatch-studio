...
GENERATORS = [
    # Luzon
    {
        ...
        "units": 2,
        "city": "Batangas City",
        "coords": [121.0700, 13.7400],
        "owner": "SMC Global Power",
    ...
    },
    {
        ...
        "capacity_mw": 1294,
        "units": 2,
        "city": "Sual, Pangasinan",
        "coords": [120.0970, 16.1170],
        "owner": "San Miguel (SMC Global Power)",
    ...
    },
    {
        ...
        "coords": [120.4833, 14.4333],
        "owner": "AC Energy + AboitizPower",
    ...
    },
    {
        ...
        "capacity_mw": 1155,
        "units": 3,
        "city": "Pagbilao, Quezon",
        "coords": [121.6833, 13.9667],
        "owner": "TeaM Energy / AboitizPower",
    ...
    },
    {
        ...
        "capacity_mw": 1340,
        "units": 4,
        "city": "Masinloc, Zambales",
        "coords": [119.9333, 15.5333],
        "owner": "SMC Global Power (MPPCL)",
    ...
    },
    {
        ...
        "units": 1,
        "city": "Mauban, Quezon",
        "coords": [121.7270, 14.1910],
        "owner": "Quezon Power (Philippines)",
    ...
    },
    {
        ...
        "units": 1,
        "city": "Mauban, Quezon",
        "coords": [121.7300, 14.1900],
        "owner": "San Buenaventura Power (MGen)",
    ...
    # Visayas
    {
        "name": "Therma Visayas (TVI)",
        "grid": "VISAYAS",
        "fuel": "coal",
        "capacity_mw": 340,
        "units": 2,
        "city": "Toledo City, Cebu",
        "coords": [123.6330, 10.3670],
        "owner": "AboitizPower",
    ...
    },
    {
        ...
        "units": 2,
        "city": "Naga City, Cebu",
        "coords": [123.7580, 10.2090],
        "owner": "KEPCO SPC / SPC Power",
    ...
    },
    {
        ...
        "units": 3,
        "city": "Iloilo City",
        "coords": [122.5850, 10.7200],
        "owner": "Global Business Power (MGen)",
...
DC_SITES = [
    ...
    },
    {
        "name": "STT GDC Makati",
        "city": "Makati",
        "coords": [121.0240, 14.5540],
        "mw": 3,
        "status": "operational",
        "src": "https://www.datacenterdynamics.com/en/news/stt-gdc-philippines-to-expand-three-data-centers/",
    },
    {
        "name": "STT GDC Quezon City",
        "city": "Quezon City",
        "coords": [121.0430, 14.6760],
        "mw": 5.5,
        "status": "operational",
        "src": "https://www.datacenterdynamics.com/en/news/stt-gdc-philippines-to-expand-three-data-centers/",
    },
    {
        "name": "STT GDC Cavite 1 and 2",
        "city": "Cavite",
        "coords": [120.9820, 14.3480],
        "mw": 10.8,
        "status": "operational",
    ...
    },
    {
        "name": "STT GDC Davao",
        "city": "Davao City",
        "coords": [125.6130, 7.0700],
        "mw": None,
        "status": "planned",
        "src": "https://www.sttelemediagdc.com/ph-en/locations",
    },
    {
        "name": "Digital Edge NARRA1",
        "city": "Metro Manila",
        "coords": [121.0000, 14.5500],
        "mw": 10,
        "status": "operational",
    ...
    {
        "name": "EdgeConneX + Aboitiz Manila",
        "city": "Manila",
        "coords": [120.9850, 14.5830],
        "mw": None,
        "status": "announced",
        "src": "https://www.edgeconnex.com/locations/asia-pacific/manila/",
    },
    {
        "name": "Converge Caloocan",
        "city": "Caloocan",
        "coords": [120.9830, 14.6570],
        "mw": 3,
        "status": "operational",
    ...
    },
    {
        "name": "Equinix MN2",
        "city": "Carmona, Cavite",
        "coords": [121.0570, 14.3160],
        "mw": 4,
        "status": "operational",
        "src": "https://baxtel.com/data-center/equinix-carmona-1",
    },
    {
        "name": "Equinix MN1/MN3",
        "city": "Makati",
        "coords": [121.0300, 14.5560],
        "mw": None,
        "status": "operational",
        "src": "https://newsroom.equinix.com/2025-10-22-Equinix-Connects-Philippine-Businesses",
    },
    {
        "name": "Narra Technology Park",
        "city": "New Clark City, Capas, Tarlac",
        "coords": [120.5560, 15.3190],
        "mw": 300,
        "status": "planned",
...
DEMAND_ANCHORS = [
    {
        "label": "DICT forecast: PH data-center capacity by 2028",
        "mw": 1500,
        "kind": "forecast",
        "owner": "DICT",
        "date": "2025-10",
    ...
    {
        "label": "Meralco committed capacity for 10 data centers",
        "mw": 1000,
        "kind": "commitment",
        "owner": "Meralco",
        "date": "2026-01",
    ...
    {
        "label": "Data Center Philippines alliance pipeline",
        "mw": 473,
        "kind": "pipeline",
        "owner": "DCPH",
        "date": "2026-02",
    ...
    {
        "label": "Operational today (contested range)",
        "mw_low": 200,
        "mw_high": 630,
        "kind": "contested",
        "owner": "DICT vs Mordor Intelligence",
        "date": "2025",
        "src": "https://pcij.org/2026/01/11/data-centers-raise-concerns/",
    },
]

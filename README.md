...
`LEYTE_TO_CEBU`** shows up in the day-ahead runs on **79 of the window's 103 days**.
The 230 kV lines that carry that corridor, Tabango (Leyte) to Daanbantayan (Cebu),
top the league: at a binding limit in the hourly day-ahead runs on **100 of 103
...
Across the 103-day window, **89 distinct pieces of equipment** hit a limit at least
...
The instruction log behind both closes the causal loop. Across the 100
...
below the stated requirement on 64 of the window's 103 days**, and load was curtailed

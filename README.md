...
`LEYTE_TO_CEBU`** shows up in the day-ahead runs on **74 of the window's 98 days**.
The 230 kV lines that carry that corridor, Tabango (Leyte) to Daanbantayan (Cebu),
top the league: at a binding limit in the hourly day-ahead runs on **95 of 98
...
Across the 98-day window, **87 distinct pieces of equipment** hit a limit at least
...
The instruction log behind both closes the causal loop. Across the 95
daily logs the System Operator's own dispatch instructions carry a remark
citing a line limitation **1,617 times, and 1,590 of those name the
...
below the stated requirement on 62 of the window's 98 days**, and load was curtailed
in the dispatch schedules on **100 grid-days (5,102.6 MWh)** across the three grids.

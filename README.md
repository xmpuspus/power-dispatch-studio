...
`LEYTE_TO_CEBU`** shows up in the day-ahead runs on **88 of the window's 112 days**.
The 230 kV lines that carry that corridor, Tabango (Leyte) to Daanbantayan (Cebu),
top the league: at a binding limit in the hourly day-ahead runs on **109 of 112
...
Across the 112-day window, **76 distinct pieces of equipment** hit a limit at least
...
The instruction log behind both closes the causal loop. Across the 109
daily logs the System Operator's own dispatch instructions carry a remark
citing a line limitation **1,680 times, and 1,653 of those name the
...
below the stated requirement on 71 of the window's 112 days**, and load was curtailed

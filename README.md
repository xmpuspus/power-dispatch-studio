...
`LEYTE_TO_CEBU`** shows up in the day-ahead runs on **85 of the window's 109 days**.
The 230 kV lines that carry that corridor, Tabango (Leyte) to Daanbantayan (Cebu),
top the league: at a binding limit in the hourly day-ahead runs on **106 of 109
...
Across the 109-day window, **76 distinct pieces of equipment** hit a limit at least
...
The instruction log behind both closes the causal loop. Across the 106
...
below the stated requirement on 68 of the window's 109 days**, and load was curtailed

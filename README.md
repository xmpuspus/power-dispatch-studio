...
`LEYTE_TO_CEBU`** shows up in the day-ahead runs on **82 of the window's 106 days**.
The 230 kV lines that carry that corridor, Tabango (Leyte) to Daanbantayan (Cebu),
top the league: at a binding limit in the hourly day-ahead runs on **103 of 106
...
Across the 106-day window, **76 distinct pieces of equipment** hit a limit at least
once, in **90 monitored constraints** (a transformer is listed under each winding
...
The instruction log behind both closes the causal loop. Across the 103
...
below the stated requirement on 65 of the window's 106 days**, and load was curtailed
in the dispatch schedules on **103 grid-days (5,214.3 MWh)** across the three grids.

...
`LEYTE_TO_CEBU`** shows up in the day-ahead runs on **73 of the window's 97 days**.
The 230 kV lines that carry that corridor, Tabango (Leyte) to Daanbantayan (Cebu),
top the league: at a binding limit in the hourly day-ahead runs on **94 of 97
...
Across the 97-day window, **87 distinct pieces of equipment** hit a limit at least
...
The instruction log behind both closes the causal loop. Across the 94
...
below the stated requirement on 61 of the window's 97 days**, and load was curtailed
in the dispatch schedules on **99 grid-days (5,042.9 MWh)** across the three grids.

...
- [Luzon reserves fell short on 73 of the window's 119 days](#luzon-reserves-fell-short-on-73-of-the-windows-119-days)
...
`LEYTE_TO_CEBU`** shows up in the day-ahead runs on **95 of the window's 119 days**.
The 230 kV lines that carry that link, Tabango (Leyte) to Daanbantayan (Cebu),
top the league. They are at a binding limit in the hourly day-ahead runs on **116 of 119
...
Across the 119-day window, **81 distinct pieces of equipment** hit a limit at least
...
The System Operator's instruction log states why it changed dispatch. Across 116
...
## Luzon reserves fell short on 73 of the window's 119 days

In the operator's real-time schedules, **Luzon reserves fell below the stated need
on 73 of the window's 119 days**. Across the three grids, the schedules curtailed
load on **106 grid-days (5,222.4 MWh)**. These figures describe published

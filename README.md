...
`LEYTE_TO_CEBU`** shows up in the day-ahead runs on **81 of the window's 105 days**.
The 230 kV lines that carry that corridor, Tabango (Leyte) to Daanbantayan (Cebu),
top the league: at a binding limit in the hourly day-ahead runs on **102 of 105
...
Across the 105-day window, **75 distinct pieces of equipment** hit a limit at least
...
The instruction log behind both closes the causal loop. Across the 102
...
below the stated requirement on 65 of the window's 105 days**, and load was curtailed

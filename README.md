...
`LEYTE_TO_CEBU`** shows up in the day-ahead runs on **78 of the window's 102 days**.
The 230 kV lines that carry that corridor, Tabango (Leyte) to Daanbantayan (Cebu),
top the league: at a binding limit in the hourly day-ahead runs on **99 of 102
...
Across the 102-day window, **89 distinct pieces of equipment** hit a limit at least
...
The instruction log behind both closes the causal loop. Across the 99
...
below the stated requirement on 64 of the window's 102 days**, and load was curtailed

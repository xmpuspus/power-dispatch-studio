...
`LEYTE_TO_CEBU`** shows up in the day-ahead runs on **87 of the window's 111 days**.
The 230 kV lines that carry that corridor, Tabango (Leyte) to Daanbantayan (Cebu),
top the league: at a binding limit in the hourly day-ahead runs on **108 of 111
...
Across the 111-day window, **76 distinct pieces of equipment** hit a limit at least
...
The instruction log behind both closes the causal loop. Across the 108
daily logs the System Operator's own dispatch instructions carry a remark
citing a line limitation **1,670 times, and 1,643 of those name the
...
below the stated requirement on 70 of the window's 111 days**, and load was curtailed

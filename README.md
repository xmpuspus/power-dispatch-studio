...
`LEYTE_TO_CEBU`** shows up in the day-ahead runs on **77 of the window's 101 days**.
The 230 kV lines that carry that corridor, Tabango (Leyte) to Daanbantayan (Cebu),
top the league: at a binding limit in the hourly day-ahead runs on **98 of 101
...
Across the 101-day window, **89 distinct pieces of equipment** hit a limit at least
...
The instruction log behind both closes the causal loop. Across the 98
...
below the stated requirement on 63 of the window's 101 days**, and load was curtailed

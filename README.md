...
`LEYTE_TO_CEBU`** shows up in the day-ahead runs on **86 of the window's 110 days**.
The 230 kV lines that carry that corridor, Tabango (Leyte) to Daanbantayan (Cebu),
top the league: at a binding limit in the hourly day-ahead runs on **107 of 110
...
Across the 110-day window, **76 distinct pieces of equipment** hit a limit at least
...
The instruction log behind both closes the causal loop. Across the 107
daily logs the System Operator's own dispatch instructions carry a remark
citing a line limitation **1,667 times, and 1,640 of those name the
...
below the stated requirement on 69 of the window's 110 days**, and load was curtailed

...
- [The Leyte-Cebu link reached a binding limit on 137 of 140 days](#the-leyte-cebu-link-reached-a-binding-limit-on-137-of-140-days)
- [Luzon reserves fell short on 76 of the window's 140 days](#luzon-reserves-fell-short-on-76-of-the-windows-140-days)
...
## The Leyte-Cebu link reached a binding limit on 137 of 140 days
...
`LEYTE_TO_CEBU`** shows up in the day-ahead runs on **114 of the window's 140 days**.
The 230 kV lines that carry that link, Tabango (Leyte) to Daanbantayan (Cebu),
top the league. They are at a binding limit in the hourly day-ahead runs on **137 of 140
...
Across the 140-day window, **89 distinct pieces of equipment** hit a limit at least
...
The System Operator's instruction log states why it changed dispatch. Across 137
daily logs, its instructions carry a remark
citing a line limitation **2,262 times, and 2,235 of those name the
...
## Luzon reserves fell short on 76 of the window's 140 days

In the operator's real-time schedules, **Luzon reserves fell below the stated need
on 76 of the window's 140 days**. Across the three grids, the schedules curtailed
load on **135 grid-days (9,411.4 MWh)**. These figures describe published
...
|---|---|
| The contracts gain | **+P10,000** |
| The uncontracted load costs more | **+P6,000** |
| Net | **+P4,000** |

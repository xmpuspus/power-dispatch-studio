...
- [The Leyte-Cebu link reached a binding limit on 136 of 139 days](#the-leyte-cebu-link-reached-a-binding-limit-on-136-of-139-days)
- [Luzon reserves fell short on 76 of the window's 139 days](#luzon-reserves-fell-short-on-76-of-the-windows-139-days)
...
## The Leyte-Cebu link reached a binding limit on 136 of 139 days
...
`LEYTE_TO_CEBU`** shows up in the day-ahead runs on **113 of the window's 139 days**.
The 230 kV lines that carry that link, Tabango (Leyte) to Daanbantayan (Cebu),
top the league. They are at a binding limit in the hourly day-ahead runs on **136 of 139
...
Across the 139-day window, **89 distinct pieces of equipment** hit a limit at least
...
The System Operator's instruction log states why it changed dispatch. Across 136
daily logs, its instructions carry a remark
citing a line limitation **2,208 times, and 2,181 of those name the
...
## Luzon reserves fell short on 76 of the window's 139 days

In the operator's real-time schedules, **Luzon reserves fell below the stated need
on 76 of the window's 139 days**. Across the three grids, the schedules curtailed
load on **133 grid-days (9,105.6 MWh)**. These figures describe published
...
P5.69/kWh to P6.00/kWh.

| Line | Change for the day |
|---|---|
| The contracts gain | **+P1,885,000** |
| The uncontracted load costs more | **+P1,131,000** |
| Net | **+P754,000** |

...
- [The Leyte-Cebu link reached a binding limit on 131 of 134 days](#the-leyte-cebu-link-reached-a-binding-limit-on-131-of-134-days)
- [Luzon reserves fell short on 76 of the window's 134 days](#luzon-reserves-fell-short-on-76-of-the-windows-134-days)
...
## The Leyte-Cebu link reached a binding limit on 131 of 134 days
...
`LEYTE_TO_CEBU`** shows up in the day-ahead runs on **108 of the window's 134 days**.
The 230 kV lines that carry that link, Tabango (Leyte) to Daanbantayan (Cebu),
top the league. They are at a binding limit in the hourly day-ahead runs on **131 of 134
...
Across the 134-day window, **86 distinct pieces of equipment** hit a limit at least
once, in **103 monitored constraints** (a transformer is listed under each winding
...
The System Operator's instruction log states why it changed dispatch. Across 131
daily logs, its instructions carry a remark
citing a line limitation **2,079 times, and 2,052 of those name the
...
The full record has
**155,352 MOT-raise instructions** across the window at a **30
MW** median.
...
## Luzon reserves fell short on 76 of the window's 134 days

In the operator's real-time schedules, **Luzon reserves fell below the stated need
on 76 of the window's 134 days**. Across the three grids, the schedules curtailed
load on **128 grid-days (8,915.3 MWh)**. These figures describe published
...
P5.56/kWh to P5.87/kWh.

| Line | Change for the day |
|---|---|
| The contracts gain | **+P1,855,250** |
| The uncontracted load costs more | **+P1,113,150** |
| Net | **+P742,100** |

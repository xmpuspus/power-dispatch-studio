...
- [The Leyte-Cebu link reached a binding limit on 142 of 145 days](#the-leyte-cebu-link-reached-a-binding-limit-on-142-of-145-days)
- [Luzon reserves fell short on 76 of the window's 145 days](#luzon-reserves-fell-short-on-76-of-the-windows-145-days)
...
## The Leyte-Cebu link reached a binding limit on 142 of 145 days
...
`LEYTE_TO_CEBU`** shows up in the day-ahead runs on **119 of the window's 145 days**.
The 230 kV lines that carry that link, Tabango (Leyte) to Daanbantayan (Cebu),
top the league. They are at a binding limit in the hourly day-ahead runs on **142 of 145
...
Across the 145-day window, **90 distinct pieces of equipment** hit a limit at least
...
The System Operator's instruction log states why it changed dispatch. Across 142
...
## Luzon reserves fell short on 76 of the window's 145 days

In the operator's real-time schedules, **Luzon reserves fell below the stated need
on 76 of the window's 145 days**. Across the three grids, the schedules curtailed
load on **145 grid-days (10,082.3 MWh)**. These figures describe published
...
P5.02/kWh to P5.55/kWh.

| Line | Change for the day |
|---|---|
| The contracts gain | **+P3,320,000** |
| The uncontracted load costs more | **+P1,832,000** |
| Net | **+P1,488,000** |

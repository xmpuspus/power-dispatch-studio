...
- [The Leyte-Cebu link reached a binding limit on 143 of 146 days](#the-leyte-cebu-link-reached-a-binding-limit-on-143-of-146-days)
- [Luzon reserves fell short on 76 of the window's 146 days](#luzon-reserves-fell-short-on-76-of-the-windows-146-days)
...
## The Leyte-Cebu link reached a binding limit on 143 of 146 days
...
`LEYTE_TO_CEBU`** shows up in the day-ahead runs on **120 of the window's 146 days**.
The 230 kV lines that carry that link, Tabango (Leyte) to Daanbantayan (Cebu),
top the league. They are at a binding limit in the hourly day-ahead runs on **143 of 146
...
Across the 146-day window, **90 distinct pieces of equipment** hit a limit at least
...
The System Operator's instruction log states why it changed dispatch. Across 143
...
## Luzon reserves fell short on 76 of the window's 146 days

In the operator's real-time schedules, **Luzon reserves fell below the stated need
on 76 of the window's 146 days**. Across the three grids, the schedules curtailed
load on **147 grid-days (10,423.9 MWh)**. These figures describe published
...
P5.01/kWh to P5.15/kWh.

| Line | Change for the day |
|---|---|
| The contracts gain | **+P839,750** |
| The uncontracted load costs more | **+P503,850** |
| Net | **+P335,900** |

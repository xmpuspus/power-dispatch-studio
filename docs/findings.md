...
- [The Leyte-Cebu link reached a binding limit on 135 of 138 days](#the-leyte-cebu-link-reached-a-binding-limit-on-135-of-138-days)
- [Luzon reserves fell short on 76 of the window's 138 days](#luzon-reserves-fell-short-on-76-of-the-windows-138-days)
...
## The Leyte-Cebu link reached a binding limit on 135 of 138 days
...
`LEYTE_TO_CEBU`** shows up in the day-ahead runs on **112 of the window's 138 days**.
The 230 kV lines that carry that link, Tabango (Leyte) to Daanbantayan (Cebu),
top the league. They are at a binding limit in the hourly day-ahead runs on **135 of 138
...
Across the 138-day window, **88 distinct pieces of equipment** hit a limit at least
once, in **105 monitored constraints** (a transformer is listed under each winding
...
The System Operator's instruction log states why it changed dispatch. Across 135
...
## Luzon reserves fell short on 76 of the window's 138 days

In the operator's real-time schedules, **Luzon reserves fell below the stated need
on 76 of the window's 138 days**. Across the three grids, the schedules curtailed
...
P5.96/kWh to P6.00/kWh.

| Line | Change for the day |
|---|---|
| The contracts gain | **+P255,000** |
| The uncontracted load costs more | **+P153,000** |
| Net | **+P102,000** |

...
- [The Leyte-Cebu link reached a binding limit on 127 of 130 days](#the-leyte-cebu-link-reached-a-binding-limit-on-127-of-130-days)
- [Luzon reserves fell short on 76 of the window's 130 days](#luzon-reserves-fell-short-on-76-of-the-windows-130-days)
...
## The Leyte-Cebu link reached a binding limit on 127 of 130 days
...
`LEYTE_TO_CEBU`** shows up in the day-ahead runs on **105 of the window's 130 days**.
The 230 kV lines that carry that link, Tabango (Leyte) to Daanbantayan (Cebu),
top the league. They are at a binding limit in the hourly day-ahead runs on **127 of 130
...
Across the 130-day window, **84 distinct pieces of equipment** hit a limit at least
...
The System Operator's instruction log states why it changed dispatch. Across 127
...
## Luzon reserves fell short on 76 of the window's 130 days

In the operator's real-time schedules, **Luzon reserves fell below the stated need
on 76 of the window's 130 days**. Across the three grids, the schedules curtailed
load on **122 grid-days (8,155.8 MWh)**. These figures describe published

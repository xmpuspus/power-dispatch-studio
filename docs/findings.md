...
- [The Leyte-Cebu link reached a binding limit on 138 of 141 days](#the-leyte-cebu-link-reached-a-binding-limit-on-138-of-141-days)
- [Luzon reserves fell short on 76 of the window's 141 days](#luzon-reserves-fell-short-on-76-of-the-windows-141-days)
...
## The Leyte-Cebu link reached a binding limit on 138 of 141 days
...
`LEYTE_TO_CEBU`** shows up in the day-ahead runs on **115 of the window's 141 days**.
The 230 kV lines that carry that link, Tabango (Leyte) to Daanbantayan (Cebu),
top the league. They are at a binding limit in the hourly day-ahead runs on **138 of 141
...
Across the 141-day window, **89 distinct pieces of equipment** hit a limit at least
...
The System Operator's instruction log states why it changed dispatch. Across 138
daily logs, its instructions carry a remark
citing a line limitation **2,413 times, and 2,386 of those name the
...
## Luzon reserves fell short on 76 of the window's 141 days

In the operator's real-time schedules, **Luzon reserves fell below the stated need
on 76 of the window's 141 days**. Across the three grids, the schedules curtailed
load on **137 grid-days (9,590.1 MWh)**. These figures describe published

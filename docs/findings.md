...
- [The Leyte-Cebu link reached a binding limit on 144 of 147 days](#the-leyte-cebu-link-reached-a-binding-limit-on-144-of-147-days)
- [Luzon reserves fell short on 76 of the window's 147 days](#luzon-reserves-fell-short-on-76-of-the-windows-147-days)
...
## The Leyte-Cebu link reached a binding limit on 144 of 147 days
...
`LEYTE_TO_CEBU`** shows up in the day-ahead runs on **121 of the window's 147 days**.
The 230 kV lines that carry that link, Tabango (Leyte) to Daanbantayan (Cebu),
top the league. They are at a binding limit in the hourly day-ahead runs on **144 of 147
...
Across the 147-day window, **90 distinct pieces of equipment** hit a limit at least
...
The System Operator's instruction log states why it changed dispatch. Across 144
daily logs, its instructions carry a remark
citing a line limitation **2,539 times, and 2,512 of those name the
...
## Luzon reserves fell short on 76 of the window's 147 days

In the operator's real-time schedules, **Luzon reserves fell below the stated need
on 76 of the window's 147 days**. Across the three grids, the schedules curtailed
load on **149 grid-days (10,881.3 MWh)**. These figures describe published
...
P5.20/kWh to P5.31/kWh.

| Line | Change for the day |
|---|---|
| The contracts gain | **+P650,000** |
| The uncontracted load costs more | **+P390,000** |
| Net | **+P260,000** |

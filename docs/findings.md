...
- [The Leyte-Cebu link reached a binding limit on 134 of 137 days](#the-leyte-cebu-link-reached-a-binding-limit-on-134-of-137-days)
- [Luzon reserves fell short on 76 of the window's 137 days](#luzon-reserves-fell-short-on-76-of-the-windows-137-days)
...
## The Leyte-Cebu link reached a binding limit on 134 of 137 days
...
`LEYTE_TO_CEBU`** shows up in the day-ahead runs on **111 of the window's 137 days**.
The 230 kV lines that carry that link, Tabango (Leyte) to Daanbantayan (Cebu),
top the league. They are at a binding limit in the hourly day-ahead runs on **134 of 137
...
Across the 137-day window, **86 distinct pieces of equipment** hit a limit at least
...
The System Operator's instruction log states why it changed dispatch. Across 134
daily logs, its instructions carry a remark
citing a line limitation **2,206 times, and 2,179 of those name the
...
## Luzon reserves fell short on 76 of the window's 137 days

In the operator's real-time schedules, **Luzon reserves fell below the stated need
on 76 of the window's 137 days**. Across the three grids, the schedules curtailed
...
P6.00/kWh to P5.87/kWh.

| Line | Change for the day |
|---|---|
| The contracts gain | **+P785,000** |
| The uncontracted load costs more | **+P471,000** |
| Net | **+P314,000** |

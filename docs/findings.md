...
- [The Leyte-Cebu link reached a binding limit on 126 of 129 days](#the-leyte-cebu-link-reached-a-binding-limit-on-126-of-129-days)
- [Luzon reserves fell short on 76 of the window's 129 days](#luzon-reserves-fell-short-on-76-of-the-windows-129-days)
...
## The Leyte-Cebu link reached a binding limit on 126 of 129 days
...
`LEYTE_TO_CEBU`** shows up in the day-ahead runs on **104 of the window's 129 days**.
The 230 kV lines that carry that link, Tabango (Leyte) to Daanbantayan (Cebu),
top the league. They are at a binding limit in the hourly day-ahead runs on **126 of 129
...
Across the 129-day window, **84 distinct pieces of equipment** hit a limit at least
...
The System Operator's instruction log states why it changed dispatch. Across 126
daily logs, its instructions carry a remark
citing a line limitation **2,002 times, and 1,975 of those name the
...
## Luzon reserves fell short on 76 of the window's 129 days

In the operator's real-time schedules, **Luzon reserves fell below the stated need
on 76 of the window's 129 days**. Across the three grids, the schedules curtailed
load on **121 grid-days (8,058.3 MWh)**. These figures describe published
...
1.5 GW demand increase raises the Luzon daily mean by **+P3.50/kWh** on the cost
...
P5.87/kWh to P6.00/kWh.

| Line | Change for the day |
|---|---|
| The contracts gain | **+P765,000** |
| The uncontracted load costs more | **+P459,000** |
| Net | **+P306,000** |

...
- [The Leyte-Cebu link reached a binding limit on 145 of 148 days](#the-leyte-cebu-link-reached-a-binding-limit-on-145-of-148-days)
- [Luzon reserves fell short on 76 of the window's 148 days](#luzon-reserves-fell-short-on-76-of-the-windows-148-days)
...
## The Leyte-Cebu link reached a binding limit on 145 of 148 days
...
`LEYTE_TO_CEBU`** shows up in the day-ahead runs on **122 of the window's 148 days**.
The 230 kV lines that carry that link, Tabango (Leyte) to Daanbantayan (Cebu),
top the league. They are at a binding limit in the hourly day-ahead runs on **145 of 148
...
Across the 148-day window, **90 distinct pieces of equipment** hit a limit at least
...
The System Operator's instruction log states why it changed dispatch. Across 145
...
## Luzon reserves fell short on 76 of the window's 148 days

In the operator's real-time schedules, **Luzon reserves fell below the stated need
on 76 of the window's 148 days**. Across the three grids, the schedules curtailed
load on **150 grid-days (10,971.7 MWh)**. These figures describe published
...
P5.67/kWh to P5.92/kWh.

| Line | Change for the day |
|---|---|
| The contracts gain | **+P1,450,000** |
| The uncontracted load costs more | **+P870,000** |
| Net | **+P580,000** |

"""Open all 40 studio views by deep link, shoot each one, tile them into a sheet.

The README has to show what the studio can do without downloading 40 clips.
...
It also checks all 40 deep links. `#v=<slug>` is
